...
INDEX_TYPE = "newprod-charging-snapshots-repo"
# INDEX_TYPE = "newprod-grid-snapshots-repo"
=======
MONTH = 12
INDEX_NAME = "tmh_grid_prod_marketplace_exchange_from_lc_v2.0"
#INDEX_TYPE = "newprod-charging-snapshots-repo"
INDEX_TYPE = "newprod-grid-snapshots-repo"
>>>>>>> Stashed changes
############### custom input ends ###############
...
=======
            "rename_replacement": "script_test_$1"
>>>>>>> Stashed changes
        }
